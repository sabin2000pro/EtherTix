...
var users = JSON.parse(fs_1.default.readFileSync(path_1.default.join(__dirname, '../data/users.json')).toString());
(0, auth_db_1.default)();
...
var removeUserData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
