...
import { fetchAllTickets, createNewTicket, getEventTicketById, editTicketByID, deleteTicketByID, deleteAllTickets, fetchTicketEventDetails } from '../controllers/ticket-controller';
