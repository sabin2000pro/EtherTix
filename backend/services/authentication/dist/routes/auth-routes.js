...
exports.authRouter.route('/resend-email-verification').post(rateLimiter, auth_controller_1.resendEmailVerificationCode);
...
exports.authRouter.route('/resend-login-mfa').post(rateLimiter, auth_controller_1.resendTwoFactorLoginCode);
...
exports.authRouter.route('/reset-password/:resetToken').post(rateLimiter, auth_controller_1.resetPassword);
exports.authRouter.route('/update-profile').put(rateLimiter, auth_middleware_1.protectAuth, auth_controller_1.updateUserProfile);
exports.authRouter.route('/update-password').put(rateLimiter, auth_middleware_1.protectAuth, auth_controller_1.updateUserPassword);
