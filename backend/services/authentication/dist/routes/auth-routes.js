...
exports.authRouter.route('/register').post(rateLimiter, validation_middleware_1.registerUserValidationAgent, auth_controller_2.registerUser);
...
exports.authRouter.route('/logout').get(rateLimiter, auth_middleware_1.protectAuth, auth_controller_2.logoutUser);
...
exports.authRouter.route('/me').get(auth_controller_2.getCurrentUser);
